                ...
                <div className={style.wrap}>
                    ...
                    <div className={style.contactInfo}>
                        <div className={style.contact}>
                            <span
                                className={style.contactTitle}>С удовольствием ответим на Ваши вопросы с 9:00 до 17:00 <br/> по московскому времени</span>
                            <span className={style.contactText} style={{color: "#5DB8B2"}}>+7 (777) 777 77 77</span>
                            <span className={style.contactTitle}>По вопросам гарантийного обслуживания</span>
                            <span className={style.contactText}>support@gmail.com</span>
                            <span className={style.contactTitle}>По вопросам сотрудничества</span>
                            <span className={style.contactText} style={{marginBottom: 0}}>ivanov.ivan@gmail.com</span>
                        ...
                        <div className={style.social}>
                            ...
                            <div style={{display: "flex", alignItems: "flex-start", flexDirection: "column"}}>
                                <span className={style.contactTitle}>Новостной канал в Telegram</span>
